...
# Updated CSV path
csv_path = "~/Library/CloudStorage/OneDrive-KULeuven/Uganda_Congo/Data/Uganda/D_Uganda_20m_simple.csv" #This is a simplified version of the final data (only including id_unique, start_date, today, ID, Watercontactsite, latitude and longitude).
output_csv_path = "~/Library/CloudStorage/OneDrive-KULeuven/Uganda_Congo/Data/Uganda/D_Uganda_utm_coordinates.csv"
